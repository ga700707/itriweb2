...
function purchase2Edit(id) {
    ...
    $.ajax({
        ...
        success: function (e) {
            ...
            if (e.purchaseOrderPredictDate != null)
                $("#purchaseOrderPredictDateEdit").val(moment(e.purchaseOrderPredictDate).format('YYYY/MM/DD hh:mm'));
            if (e.purchaseOrderCompleteDate != null)
